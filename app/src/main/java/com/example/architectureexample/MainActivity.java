...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //to make our recycler view swipe-able
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                noteViewModel.delete(adapter.getNoteAt(viewHolder.getAdapterPosition()));           // getAdapterPosition -  which position in adapter we swiped off the item
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == ADD_NOTE_REQUEST && resultCode==RESULT_OK) {
            ...
            Note note = new Note(title,description,priority);
            note.setId(id);     // without this it can't identify the note
